...
var moduleUnderTest = require("../../app/pg-utils.js")
var assert = require('chai').assert;

describe('pg-utils module', function() {
    describe('featureCollectionSQL', function () {
        it('should return expected SQL string with all options (geom and where clause)', function () {
            ...
            var result = moduleUnderTest.featureCollectionSQL("testTable","testCol1,testCol2", {geometryColumn: "testGeomCol", whereClause: "WHERE id = $1"});
        ...
        it('should return expect SQL string with no options (no geom or where clause)', function () {
            ...
            var result = moduleUnderTest.featureCollectionSQL("testTable","testCol1,testCol2");
